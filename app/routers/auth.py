...
from app.serializers.userSerializers import userEntity, userResponseTestEntity, userListEntity
...
async def create_user(payload: schemas.CreateUserSchema,  response: Response, request: Request,  Authorize: AuthJWT = Depends()):
